...
.insert_xaxis_grob <- function(
  ...
  if (position[1] == "top") {
    ...
    g <- gtable::gtable_add_grob(
      ...
      pp$r,
      clip = "inherit", name = "xaxis-grob-t"
    )
  } else {
    ...
    g <- gtable::gtable_add_grob(
      g, grob, pp$b + 1, pp$l,
      pp$b + 1, pp$r,
      clip = "inherit", name = "xaxis-grob-b"
    )
  }
}
...
.insert_yaxis_grob <- function(
  ...
  if (position[1] == "right") {
    ...
    g <- gtable::gtable_add_grob(
      g, grob, pp$t, pp$r + 1,
      pp$b, pp$r + 1,
      clip = "inherit", name = "yaxis-grob-r"
    )
  } else {
    ...
    g <- gtable::gtable_add_grob(
      ...
      pp$l,
      clip = "inherit", name = "yaxis-grob-l"
    )
  }
}
